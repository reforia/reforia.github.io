...
tldr: >-
  Ubisoft's The Division 2 TU19 added a new co-op Incursion mode, on which this
  work built the Hellfire melee boss tech: behavior tree and boss manager logic
  covering phase-change detection, custom pathfinding swifter than players,
  enrage mode, and contextual melee that only lands on CC-ed targets, plus the
  mission technical skeleton, core AI, collectibles, and mission flow.
