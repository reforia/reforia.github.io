...
tldr: >-
  Go Go Kart is a UE4 4-player split-screen arcade racer where the author built the VFX and audio systems, using GPU-particle collision sparks, decal-based self ambient shadowmaps, and pure vertex/pixel-shader bobbing coins to save CPU budget. A component-driven PlayFXOnCar framework and a Sound-Class ducking system that lowers AI-triggered audio round out the tech.
