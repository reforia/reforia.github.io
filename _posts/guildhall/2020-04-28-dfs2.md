...
tldr: >-
  "Miner Cave" is a hack-and-slash action RPG custom game mode built in DotA2,
  set in a monster-haunted abandoned mine where the player controls a legendary
  sword master. It delivers a roughly 15-minute campaign of fast-paced combat
  against RNG-based hordes, with skill-and-item combinations driving progression.
