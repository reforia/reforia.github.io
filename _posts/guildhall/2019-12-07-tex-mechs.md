...
tldr: >-
  Tex-Mechs is a mech shooter built in Unreal Engine 4.22 by 17 SMU Guildhall
  students over five months, pitting pilots against an insect horde in the Texas
  barrens. Technical highlights include a Sound Cue and sound-class audio system
  with master-class ducking, the menu flow, and a lightweight custom tag system
  backed by a C++ UTagObject that overrides GetWorld().
